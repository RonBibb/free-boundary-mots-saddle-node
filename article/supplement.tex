...
\hypersetup{
  ...
  pdftitle={Supplemental Material: Normal-Form Resolution of a Free-Boundary MOTS Saddle-Node in Dynamical Five-Dimensional Gravity},
...
``Normal-Form Resolution of a Free-Boundary MOTS Saddle-Node\\
...
crossing, the endpoint-eliminated discrete adjoint transversality and
quadratic coefficients are nonzero,
